...
\begin{tikzpicture}
	\node at (0,0) (ard1) [anchor=south west,draw,minimum height=3,inner sep=1] {Arduino 1};
	\node (ard2) [left=of ard1,anchor=south west,draw,minimum height=3,inner sep=1] {Arduino 2};
\end{tikzpicture}
